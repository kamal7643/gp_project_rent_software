...
def customer(root,head):
    print("customer")
    clear(root)
    rent_button = tk.Button(text="rent", width="20", background="blue", font=("Arial Bold", 12),command=lambda : get_rent(root,head))
    return_button = tk.Button(text="return", width="20", background="blue", font=("Arial Bold", 12),command=lambda : return_frame(root,head))
